# maczo Originals — Diamonds · Provably Fair

Welcome. This wiki explains how every **Diamonds** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Diamonds's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=diamonds
- **Source / Node CLI:** https://github.com/maczo-co/originals-diamonds
- **Published odds:** https://verify.maczo.co/originals/paytables/diamonds.json
